...
public class UserServiceImpl implements IUserService {
    ...
    public ServerResponse<String> checkValid(String str, String type) {
        // 此处校验用的是isNotBlank而不是isNotEmpty，两者在" "上的返回值不一样，我们需要返回false的，故用isNotBlank
    ...
    public ServerResponse<String> forgetResetPassword(String username, String passwordNew, String forgetToken) {
        ...
        // 这个equals方法安全，因为会防止空指针异常（String中的equals需要另一个字符串来调用，如果另一个字符串为null，就会报空指针异常）
    ...
    public ServerResponse<String> resetPassword(String passwordOld, String passwordNew, User user) {
        ...
        // 因为我们会查询一个count(1) 出来，如果不指定id，那么结果可能就是true，count > 0
        ...
        return ServerResponse.createBySuccessMessage("密码更改失败");
    }


    public ServerResponse<User> updateInformation(User user) {
        // username是不能更新的
        // email也要进行一个校验，校验新的email是不是已经存在了，并且存在的email如果相同的话，不能是我们当前的用户
